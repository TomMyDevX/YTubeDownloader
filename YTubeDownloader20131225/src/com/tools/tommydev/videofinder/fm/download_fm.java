...
import com.tools.tommydev.videofinder.Adapter.Download_adapter;
...
public class download_fm extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.download_fm, container, false);
        ...
        DBClass_Downloader dbClass_downloader = new DBClass_Downloader(download_fm.this.getActivity());
        final List<DBClass_Downloader.File_Downloader> file_downloaders = dbClass_downloader.SelectAllData("1");
        Download_adapter Download_adapter = new Download_adapter(download_fm.this.getActivity(), file_downloaders);
            ...
            list_download.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
                ...
                public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int i, long l) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(download_fm.this.getActivity());
                            ...
                            .setItems(R.array.colors_array, new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (which == 0) {
                                        ...
                                        final EditText input = new EditText(download_fm.this.getActivity());
                                        final AlertDialog.Builder X = new AlertDialog.Builder(download_fm.this.getActivity())
                                                .setTitle("Rename To..")
                                                ...
                                                .setPositiveButton("Rename", new DialogInterface.OnClickListener() {
													...
													public void onClick(DialogInterface dialog, int whichButton) {
                                                        ...
                                                        if (b) {
                                                            ...
                                                            from.renameTo(to);
                                                            DBClass_Downloader dbClass_downloader1 = new DBClass_Downloader(download_fm.this.getActivity());
                                                            ...
                                                            new AlertUIHelper(download_fm.this.getActivity()).show("Can't rename with [^/./\\:*?\"<>|].", Gravity.BOTTOM, 500);
                                                        }
                                        ...
                                        new AlertDialog.Builder(download_fm.this.getActivity())
                                                ...
                                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        if (strings != null) {
                                                            ...
                                                            new AlertUIHelper(download_fm.this.getActivity()).show("Error on delete.", Gravity.CENTER, 20);
                                                        }
                                                    }
                                        ...
                                        AlertDialog.Builder builder = new AlertDialog.Builder(download_fm.this.getActivity());
                                        TextView textView = new TextView(download_fm.this.getActivity());
                                        ...
                                        if(strings!=null){
                                            ...
                                            if (f.exists()) {
                                            	try{
                                            		...
                                            		Toast.makeText(download_fm.this.getActivity(), "Not found media player.", Toast.LENGTH_SHORT).show();
                                            	}
