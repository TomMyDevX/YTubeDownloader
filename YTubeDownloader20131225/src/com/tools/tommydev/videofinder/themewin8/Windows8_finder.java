...
import com.tools.tommydev.videofinder.fm.windows8_src_fm;

import android.os.Bundle;
import android.support.v4.app.FragmentActivity;

public class Windows8_finder extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		windows8_src_fm firstFragment = new windows8_src_fm();
