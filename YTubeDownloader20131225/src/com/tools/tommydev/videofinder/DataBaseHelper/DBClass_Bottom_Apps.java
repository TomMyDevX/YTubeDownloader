...
public class DBClass_Bottom_Apps extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "ytube_bottom_apps";

    // Table Name
    private static final String TABLE_MEMBER = "data";

    public DBClass_Bottom_Apps(Context context) {
